...
def Ref():
    ...
    dinnercost = "E",str('%.2f'% (adoboprice +  adobongbaboyprice + hiponprice + karikariprice + paksiwprice + drinksprice))
    ...
    Service="E",str('%.2f'% Ser_Charge)
    OverAllCost="E",str( PayTax + Totalcost + Ser_Charge)
    PaidTax="E",str('%.2f'% PayTax)
...
def price():
    ...
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="Starters", fg="red", anchor=W)
    ...
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="Deserts", fg="red", anchor=W)
